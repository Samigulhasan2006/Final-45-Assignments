...
// Step 1 arrays
const current_users : string[] = ["Furqan","Kamran","Muhammad Sami","Hashir"];

const new_users: string[] = ["asif", "kashan","Ali","zeeshan"];
 ...
 function checkUserNames(current_users: string[], new_users: string[]): void
{
    ...
    for (const newUser of new_users){
        const lowercaseCurrentUser = newUser.toLowerCase();
        if (lowercaseCurrentUsers.includes(lowercaseCurrentUser)){
