...
let names : string[] = [`Hashir`,`wasif`,`Amaan`,`Hassan`,`yosuf`,`Afaq`]

// Loop message to the each person

for (let name of names)
{

console.log(`Assalam o alaikum ${name} I hope so you are happy in your life`)
